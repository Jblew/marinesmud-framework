...
public class WebSocketServerProtocolHandler extends WebSocketProtocolHandler {
    ...
    public WebSocketServerProtocolHandler(HttpsUsersManager usersManager, String websocketPath) {
        this(usersManager, websocketPath, null, false);
    }

    public WebSocketServerProtocolHandler(HttpsUsersManager usersManager, String websocketPath, boolean checkStartsWith) {
        this(usersManager, websocketPath, null, false, 65536, false, checkStartsWith);
    }

    public WebSocketServerProtocolHandler(HttpsUsersManager usersManager, String websocketPath, String subprotocols) {
        this(usersManager, websocketPath, subprotocols, false);
    }

    public WebSocketServerProtocolHandler(HttpsUsersManager usersManager, String websocketPath, String subprotocols, boolean allowExtensions) {
        this(usersManager, websocketPath, subprotocols, allowExtensions, 65536);
    }

    public WebSocketServerProtocolHandler(HttpsUsersManager usersManager, String websocketPath, String subprotocols,
                                          boolean allowExtensions, int maxFrameSize) {
        this(usersManager, websocketPath, subprotocols, allowExtensions, maxFrameSize, false);
    }
    ...
    public void handlerAdded(ChannelHandlerContext ctx) {
        ...
        if (cp.get(WebSocketServerProtocolHandshakeHandler.class) == null) {
            ...
            ctx.pipeline().addBefore(ctx.name(), WebSocketServerProtocolHandshakeHandler.class.getName(),
                    new WebSocketServerProtocolHandshakeHandler(usersManager, websocketPath, subprotocols,
